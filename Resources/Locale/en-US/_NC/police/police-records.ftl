...
nc-police-tab-fines = Fines
nc-police-fines-list = Fine registry
nc-police-fine-article-placeholder = Statute / article
nc-police-fine-amount-placeholder = Amount in credits
nc-police-fine-create = Issue fine to selected resident
nc-police-fine-change-status = Change fine status
nc-police-fine-list-line = #{$id} {$name} — {$amount} eb / {$status}
nc-police-fine-title-line = #{$id} {$article} — {$name}, {$amount} eb
nc-police-fine-status-line = Status: {$status}
nc-police-fine-reason-line = Basis: {$reason}
nc-police-fine-issued-line = Issued by {$actor} at {$time}
nc-police-fine-due-line = Due: {$time}
nc-police-fine-status-issued = Issued
nc-police-fine-status-paid = Paid
nc-police-fine-status-contested = Contested
nc-police-fine-status-voided = Voided
nc-police-fine-status-overdue = Overdue
