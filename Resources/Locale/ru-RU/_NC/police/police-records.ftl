...
nc-police-tab-fines = Штрафы
nc-police-fines-list = Реестр штрафов
nc-police-fine-article-placeholder = Статья / норма
nc-police-fine-amount-placeholder = Сумма в евродолларах
nc-police-fine-create = Выписать штраф выбранному жителю
nc-police-fine-change-status = Изменить статус штрафа
nc-police-fine-list-line = №{$id} {$name} — {$amount} eb / {$status}
nc-police-fine-title-line = №{$id} {$article} — {$name}, {$amount} eb
nc-police-fine-status-line = Статус: {$status}
nc-police-fine-reason-line = Основание: {$reason}
nc-police-fine-issued-line = Выписал {$actor}, {$time}
nc-police-fine-due-line = Срок оплаты: {$time}
nc-police-fine-status-issued = Выписан
nc-police-fine-status-paid = Оплачен
nc-police-fine-status-contested = Оспаривается
nc-police-fine-status-voided = Аннулирован
nc-police-fine-status-overdue = Просрочен
