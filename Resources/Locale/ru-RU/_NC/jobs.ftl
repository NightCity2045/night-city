...
nc-job-supervisors-ncpd-officers = офицеры и сержанты NCPD
nc-job-supervisors-ncpd-sergeants = сержанты NCPD
nc-job-supervisors-ncpd-lieutenants = лейтенанты NCPD
nc-job-supervisors-ncpd-commander = командир участка NCPD
nc-job-supervisors-ncpd-chief = начальник NCPD
...
job-description-ncpd-chief = Руководит NCPD в масштабах города и отвечает перед администрацией Найт-Сити.
job-name-ncpd-commander = Командир NCPD
job-description-ncpd-commander = Руководит полицейским участком, его операциями и личным составом.
job-name-ncpd-inspector = Инспектор NCPD
job-description-ncpd-inspector = Ведёт расследования тяжких преступлений вне патрульной ветки повышения.
job-name-ncpd-lieutenant = Лейтенант NCPD
job-description-ncpd-lieutenant = Руководит патрульным, следственным или тактическим подразделением участка.
