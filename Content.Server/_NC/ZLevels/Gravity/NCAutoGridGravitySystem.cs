...
public sealed partial class NCAutoGridGravitySystem : EntitySystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<NCAutoGridGravityComponent, MapInitEvent>(OnComponentInit);
    ...
    private void OnComponentInit(Entity<NCAutoGridGravityComponent> ent, ref MapInitEvent args)
    {
    ...
    private void OnGridInit(GridInitializeEvent ev)
    {
        ...
        if (mapUid == null || !HasComp<NCAutoGridGravityComponent>(mapUid.Value))
            return;
