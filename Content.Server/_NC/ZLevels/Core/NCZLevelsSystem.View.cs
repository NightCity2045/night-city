...
public sealed partial class NCZLevelsSystem
{
    ...
    private readonly EntProtoId _zEyeProto = "NCZLevelEye";
    ...
    private void InitView()
    {
        ...
        SubscribeLocalEvent<NCZLevelViewerComponent, MapInitEvent>(OnViewerInit);
        SubscribeLocalEvent<NCZLevelViewerComponent, ComponentRemove>(OnCompRemove);

        SubscribeLocalEvent<NCZLevelViewerComponent, MapUidChangedEvent>(OnViewerMapUidChanged);
        SubscribeLocalEvent<NCZPhysicsComponent, NCZLevelFallMapEvent>(OnZLevelFall);
    }
    ...
    private void UpdateView(float frameTime)
    {
        ...
        var query = EntityQueryEnumerator<NCZLevelViewerComponent, TransformComponent>();
    ...
    private void OnViewerInit(Entity<NCZLevelViewerComponent> ent, ref MapInitEvent args)
    {
        _actions.AddAction(ent, ref ent.Comp.ActionEntity, ent.Comp.ActionId);
        _meta.AddFlag(ent, MetaDataFlags.ExtraTransformEvents);
    }

    private void OnCompRemove(Entity<NCZLevelViewerComponent> ent, ref ComponentRemove args)
    {
    ...
    {
        var viewer = EnsureComp<NCZLevelViewerComponent>(ev.Entity);
        UpdateViewer((ev.Entity, viewer));
    }

    private void OnPlayerDetached(PlayerDetachedEvent ev)
    {
        RemComp<NCZLevelViewerComponent>(ev.Entity);
    }

    private void OnViewerMapUidChanged(Entity<NCZLevelViewerComponent> ent, ref MapUidChangedEvent args)
    {
        UpdateViewer(ent);
    }

    private void UpdateViewer(Entity<NCZLevelViewerComponent> ent)
    {
    ...
    private void OnZLevelFall(Entity<NCZPhysicsComponent> ent, ref NCZLevelFallMapEvent args)
    {
