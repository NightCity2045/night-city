...
public sealed partial class NCDeleteZNetworkCommand : LocalizedEntityCommands
{
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        if (!_entities.HasComponent<NCZMapNetworkComponent>(target))
        {
            shell.WriteError($"Target entity doesnt have NCZLevelsNetworkComponent {args[0]}");
            return;
        }
