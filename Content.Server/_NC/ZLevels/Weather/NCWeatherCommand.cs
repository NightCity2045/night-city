...
using Content.Shared._NC.ZLevels.Weather;
...
namespace Content.Server._NC.ZLevels.Weather;

[AdminCommand(AdminFlags.Fun)]
public sealed partial class NCWeatherCommand : LocalizedCommands
{
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        _entities.System<NCWeatherSystem>().SetWeather((target.Value, levelComp), weatherProto, duration);
    }
