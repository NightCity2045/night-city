...
public sealed partial class NCZLevelsRoofSystem
{
    ...
    {
        SubscribeLocalEvent<NCZMapNetworkComponent, NCZLevelMapNetworkUpdatedEvent>(OnMapNetworkUpdated);
    }

    private void OnMapNetworkUpdated(Entity<NCZMapNetworkComponent> ent, ref NCZLevelMapNetworkUpdatedEvent args)
    {
        RecalculateMapRoofs(ent);
    }

    private void RecalculateMapRoofs(Entity<NCZMapNetworkComponent> network)
    {
        _roofMap.Clear();
