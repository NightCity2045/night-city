...
using Content.Shared.Roles; // NC - Server-owned employment shown in character cards.
...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class CharacterSetupGui : Control
    {
        ...
        public void ReloadCharacterPickers()
        {
            ...
            {
                numberOfFullSlots++;
                ProtoId<JobPrototype>? employment = null;
                if (_preferencesManager.TryGetNCEmployment(slot, out var assignedJob))
                    employment = assignedJob;
