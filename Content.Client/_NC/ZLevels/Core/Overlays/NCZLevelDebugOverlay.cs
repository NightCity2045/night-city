...
namespace Content.Client._NC.ZLevels.Core.Overlays;

public sealed partial class NCZLevelDebugOverlay : Overlay
{
    [Dependency] private IEntityManager _entityManager = null!;
    [Dependency] private IResourceCache _cache = null!;

    private readonly NCSharedZLevelsSystem _zLevels;
    ...
    public NCZLevelDebugOverlay()
    {
        IoCManager.InjectDependencies(this);

        _zLevels = _entityManager.System<NCSharedZLevelsSystem>();
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        {
            if (!_entityManager.TryGetComponent<NCZPhysicsComponent>(uid, out var zPhys) ||
        ...
        var gridQuery = _entityManager.EntityQueryEnumerator<NCZGridComponent, TransformComponent>();
    ...
    private void DrawEntityDebug(in OverlayDrawArgs args, EntityUid uid, NCZPhysicsComponent component)
    {
...
public sealed partial class NCShowZLevelDebugCommand : LocalizedCommands
{
    ...
    {
        if (_overlayManager.HasOverlay<NCZLevelDebugOverlay>())
        {
            _overlayManager.RemoveOverlay<NCZLevelDebugOverlay>();
            return;
        }

        _overlayManager.AddOverlay(new NCZLevelDebugOverlay());
    }
}
