...
namespace Content.Shared._NC.ZLevels.Core.Components;

/// <summary>
/// Runtime-only nullspace manager entity for a z-grid network.
/// Always reconstructed by <see cref="NCZGridConnectorSystem"/> — not persisted.
/// </summary>
[RegisterComponent, NetworkedComponent, AutoGenerateComponentState]
public sealed partial class NCZGridNetworkComponent : Component
{
    ...
    /// Its own <see cref="NCZGridComponent.NetworkOffset"/>/<see cref="NCZGridComponent.NetworkRotation"/> are zero.
    /// </summary>
    [ViewVariables]
