...
public static class NCFilter
{
    ...
    public static Filter ZPvsExcept(EntityUid origin, IEntityManager? entManager = null)
    {
        ...
        var zSystem = entManager.System<NCSharedZLevelsSystem>();
        ...
        for (var i = 1; i <= NCSharedZLevelsSystem.MaxZLevelsBelowRendering; i++)
        {
