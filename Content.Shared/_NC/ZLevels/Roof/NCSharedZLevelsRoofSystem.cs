...
namespace Content.Shared._NC.ZLevels.Roof;
...
/// </summary>
public abstract partial class NCSharedZLevelsRoofSystem : EntitySystem
{
    [Dependency] protected NCSharedZLevelsSystem ZLevel = null!;
    ...
    [Dependency] protected EntityQuery<NCZMapComponent> ZMapQuery = default!;

    public override void Initialize()
    {
        base.Initialize();

        SubscribeLocalEvent<NCZLevelRoofComponent, TileChangedEvent>(OnTileChanged);
    }

    private void OnTileChanged(Entity<NCZLevelRoofComponent> ent, ref TileChangedEvent args)
    {
