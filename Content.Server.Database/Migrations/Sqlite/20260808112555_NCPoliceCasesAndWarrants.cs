...
public partial class NCPoliceCasesAndWarrants : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                nc_police_case_id = table.Column<long>(type: "INTEGER", nullable: false)
                ...
                created_by_name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                nc_police_case_entry_id = table.Column<long>(type: "INTEGER", nullable: false)
                    .Annotation("Sqlite:Autoincrement", true),
                case_id = table.Column<long>(type: "INTEGER", nullable: false),
                entry_type = table.Column<byte>(type: "INTEGER", nullable: false),
                text = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                previous_status = table.Column<byte>(type: "INTEGER", nullable: true),
                new_status = table.Column<byte>(type: "INTEGER", nullable: true),
                subject_profile_id = table.Column<int>(type: "INTEGER", nullable: true),
                subject_name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                subject_role = table.Column<byte>(type: "INTEGER", nullable: true),
                author_profile_id = table.Column<int>(type: "INTEGER", nullable: true),
                author_name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                character_name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                nc_police_warrant_id = table.Column<long>(type: "INTEGER", nullable: false)
                    .Annotation("Sqlite:Autoincrement", true),
                ...
                resolved_by_name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                resolution_reason = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
