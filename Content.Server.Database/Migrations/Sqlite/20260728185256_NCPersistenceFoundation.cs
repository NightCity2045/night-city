        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    account_number = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    account_type = table.Column<byte>(type: "INTEGER", nullable: false),
                    owner_profile_id = table.Column<int>(type: "INTEGER", nullable: true),
                    currency_prototype_id = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    balance = table.Column<long>(type: "INTEGER", nullable: false),
                    status = table.Column<byte>(type: "INTEGER", nullable: false),
                    credential_hash = table.Column<byte[]>(type: "BLOB", nullable: true),
                    credential_salt = table.Column<byte[]>(type: "BLOB", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    license_prototype_id = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    declared_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    declared_by_account_id = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    counted = table.Column<bool>(type: "INTEGER", nullable: false),
                    first_joined_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    last_seen_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    counted_at = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    profile_id = table.Column<int>(type: "INTEGER", nullable: false),
                    skill_prototype_id = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    deleted_character_audit_id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    deleted_profile_id = table.Column<int>(type: "INTEGER", nullable: false),
                    last_character_name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    account_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    deletion_reason = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    round_id = table.Column<int>(type: "INTEGER", nullable: true),
                    actor_account_id = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    property_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    prototype_id = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    map_entity_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    property_type = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    status = table.Column<byte>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    credited_at = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    bank_transaction_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    request_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    debit_account_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    credit_account_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    ...
                    actor_profile_id = table.Column<int>(type: "INTEGER", nullable: true),
                    round_id = table.Column<int>(type: "INTEGER", nullable: true),
                    debit_balance_after = table.Column<long>(type: "INTEGER", nullable: true),
                    credit_balance_after = table.Column<long>(type: "INTEGER", nullable: true),
                    timestamp = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_nc_bank_transaction_nc_bank_account_ncbank_account_bank_account_id",
                        column: x => x.credit_account_id,
                        principalTable: "nc_bank_account",
                        principalColumn: "bank_account_id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_nc_bank_transaction_nc_bank_account_ncbank_account_bank_account_id1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    business_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    business_type = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    property_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    bank_account_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    status = table.Column<byte>(type: "INTEGER", nullable: false),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    property_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    owner_type = table.Column<byte>(type: "INTEGER", nullable: false),
                    owner_id = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    share_basis_points = table.Column<int>(type: "INTEGER", nullable: false),
                    ownership_type = table.Column<byte>(type: "INTEGER", nullable: false),
                    acquired_at = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    employment_state = table.Column<byte>(type: "INTEGER", nullable: false),
                    hired_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    hired_by_profile_id = table.Column<int>(type: "INTEGER", nullable: true),
                    last_promotion_at = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    employment_history_id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    profile_id = table.Column<int>(type: "INTEGER", nullable: false),
                    organization_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    old_department_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    new_department_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    old_position_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    new_position_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    action = table.Column<byte>(type: "INTEGER", nullable: false),
                    actor_profile_id = table.Column<int>(type: "INTEGER", nullable: true),
                    actor_admin_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    reason = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    round_id = table.Column<int>(type: "INTEGER", nullable: true),
                    timestamp = table.Column<DateTime>(type: "TEXT", nullable: false),
                    request_id = table.Column<Guid>(type: "TEXT", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    prototype_id = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    default_entry_position_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    bank_account_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    status = table.Column<byte>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_nc_organization_nc_bank_account_ncbank_account_bank_account_id",
                        column: x => x.bank_account_id,
                        principalTable: "nc_bank_account",
                        principalColumn: "bank_account_id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    base_salary = table.Column<long>(type: "INTEGER", nullable: false),
                    pay_interval_seconds = table.Column<int>(type: "INTEGER", nullable: false),
                    payroll_account_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    is_leadership = table.Column<bool>(type: "INTEGER", nullable: false),
                    can_hire = table.Column<bool>(type: "INTEGER", nullable: false),
                    can_promote = table.Column<bool>(type: "INTEGER", nullable: false),
                    can_demote = table.Column<bool>(type: "INTEGER", nullable: false),
                    can_transfer = table.Column<bool>(type: "INTEGER", nullable: false),
                    can_suspend = table.Column<bool>(type: "INTEGER", nullable: false),
                    can_dismiss = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_nc_character_employment_nc_department_ncdepartment_department_id",
                table: "nc_character_employment",
                column: "department_id",
                principalTable: "nc_department",
                principalColumn: "department_id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_nc_character_employment_nc_organization_ncorganization_organization_id",
                table: "nc_character_employment",
                column: "organization_id",
                principalTable: "nc_organization",
                principalColumn: "organization_id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_nc_employment_history_nc_organization_ncorganization_organization_id",
                table: "nc_employment_history",
                column: "organization_id",
                principalTable: "nc_organization",
                principalColumn: "organization_id",
