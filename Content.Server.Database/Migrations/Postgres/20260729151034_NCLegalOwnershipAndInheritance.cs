        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    document_prototype_id = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    inheritance_case_id = table.Column<Guid>(type: "uuid", nullable: false),
                    asset_type = table.Column<byte>(type: "smallint", nullable: false),
                    ...
                    resolved_owner_type = table.Column<byte>(type: "smallint", nullable: true),
                    resolved_owner_id = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    resolved_by_account_id = table.Column<Guid>(type: "uuid", nullable: true),
                    reason = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false)
                },
                constraints: table =>
                {
